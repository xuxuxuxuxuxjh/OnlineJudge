...
from ..views.oj import SubmissionAPI, SubmissionListAPI, ContestSubmissionListAPI, SubmissionExistsAPI, AIModifyCodeAPI
...
urlpatterns = [
    ...
    url(r"^ai_modify_code/?$", AIModifyCodeAPI.as_view(), name="ai_modify_code_api"),
]
